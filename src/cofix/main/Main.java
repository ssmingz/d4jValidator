...
public class Main {
    ...
    private static void trySplitFix(Subject subject, boolean purify) throws IOException {
        ...
        // Use your own Patch Provider
    StaticProvider provider = new StaticProvider();
//        FileProvider provider = new FileProvider(subject.getName(), subject.getId());
        for (Pair<String, Integer> location : subject.getAbstractFaultlocalization()
                .getLocations(100)) {
            Validator validator = new Validator(subject, location);
